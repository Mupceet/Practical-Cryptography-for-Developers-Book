...
* [Welcome](README.md)
* [前言](preface.md)
* [密码学——概述](cryptography-overview.md)
* [哈希函数](cryptographic-hash-functions/README.md)
  * [加密哈希和碰撞](cryptographic-hash-functions/crypto-hashes-and-collisions.md)
  * [哈希函数：应用场景](cryptographic-hash-functions/hash-functions-applications.md)
  * [安全哈希算法](cryptographic-hash-functions/secure-hash-algorithms.md)
  * [哈希函数——示例](cryptographic-hash-functions/hash-functions-examples.md)
  * [练习：计算哈希值](cryptographic-hash-functions/exercises-calculate-hashes.md)
  * [工作量证明（Proof-of-Work）哈希函数](cryptographic-hash-functions/proof-of-work-hash-functions.md)
* [MAC 和密钥派生](mac-and-key-derivation/README.md)
  * [HMAC 与密钥派生](mac-and-key-derivation/hmac-and-key-derivation.md)
  * [HMAC 计算——示例](mac-and-key-derivation/hmac-calculation-examples.md)
  * [练习：计算 HMAC](mac-and-key-derivation/exercises-calculate-hmac.md)
